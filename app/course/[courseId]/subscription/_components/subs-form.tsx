            ...
            <CardHeader>
                ...
                <div className="grid gap-4">
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <Input id="first-name" placeholder="Ryan" onChange={(e)=>setFirstName(e.target.value)} required />
                        </div>
                        <div className="grid gap-2">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <Input id="cvv" placeholder="000" onChange={(e)=>setCvv(e.target.value)}  required />
                        </div>
                    </div>
                    <Button type="submit" className="w-full" onClick={subscribe}>
                        Subscribe
                    </Button>
                </div>
